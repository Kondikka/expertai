...
JAP_nippon_sharyo_organization = {
	include = generic_train_organization
	icon = GFX_idea_JAP_nippon_sharyo
	...
	initial_trait = {
		name = generic_mio_initial_trait_generic_train_manufacturer
		limit_to_equipment_type = { 
			train_equipment 
			#support_equipment
		}
		...
		organization_modifier = {
			military_industrial_organization_research_bonus = 0.05 #5% from MIO base
		}
	}
