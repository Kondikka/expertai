...
NDefines.NAI.UPGRADES_DEFICIT_LIMIT_DAYS = 180 --50                           -- Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
...
NDefines.NAI.MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.0 --0.7			            -- Cancel unit production if below this to get resources out to units in the field
NDefines.NAI.MIN_MANPOWER_TO_BUILD_UNITS = 0.0 --0.7					        -- Cancel unit production if below this to get resources out to units in the field
...
NDefines.NAI.PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 1.0
...
NDefines.NAI.NEW_LEADER_EXTRA_PP_FACTOR = 6.0 --2.0								 -- Country must have at least this many times extra PP to get new admirals or army leaders
...
--NDefines.NAI.AIR_ALLY_TERRITORY_INTERCEPT_SCORE = -400			-- Interception score per ally controlled state in mission region
...
--NDefines.NAI.AIR_CAS_SCORE_FACTOR = 25.0						-- Factor applied to (friendly units) x (enemy units)) to get CAS score for region
--NDefines.NAI.AIR_ENEMY_SUPERIORITY_FACTOR = 5.0					-- How much enemy air superiority counts relative to own
--NDefines.NAI.AIR_SUPERIORITY_FACTOR = 2.5						-- Factor for air superiority score
NDefines.NAI.AIR_MIN_ASSIGN_SCORE = 1 --10							-- Minimum total score for region to be considered for air missions
NDefines.NAI.AIR_MIN_REASSIGN_SCORE = 1 --25						-- Minimum total score for region to be considered for reassigning air missions
NDefines.NAI.AIR_WING_SIZE_FACTOR = 1000 --1.0							-- Impact on air score of assigning wings to mission
--NDefines.NAI.AIR_MISSION_MIN_COVEREAGE = 0.2					-- Between 0 and 1 limit for % coverage for air mission to be considered
--NDefines.NAI.AIR_BASE_PRIORITY_DISTANCE_FACTOR = 25.0			-- Weight of distance between region and airbase for airbase priority score
...
NDefines.NAI.LAND_DEFENSE_AIR_SUPERIORITY_IMPORTANCE = 0.1 --0.10		-- Strategic importance of air superiority ( amount of enemy planes in area )
...
NDefines.NAI.LAND_DEFENSE_MIN_FACTORIES_FOR_AIR_IMPORTANCE = 30 --6		-- If amount of factories is less importance of factories won't apply

NDefines.NAI.LAND_DEFENSE_FIGHERS_PER_PLANE = 0 --1.1				-- Amount of air superiority planes requested per enemy plane
NDefines.NAI.LAND_DEFENSE_INTERSEPTORS_PER_BOMBERS = 1.1 --0.2		-- Amount of air interceptor planes requested per enemy plane
...
NDefines.NAI.LAND_COMBAT_FRIEND_ARMIES_AIR_IMPORTANCE = 1 --12		-- Strategic importance of friendly armies
NDefines.NAI.LAND_COMBAT_FRIEND_COMBATS_AIR_IMPORTANCE = 1 --6		-- Strategic importance of friendly armies in the combat
NDefines.NAI.LAND_COMBAT_ENEMY_ARMIES_AIR_IMPORTANCE = 1 --8		-- Strategic importance of our armies
NDefines.NAI.LAND_COMBAT_ENEMY_LAND_FORTS_AIR_IMPORTANCE = 0 --5	-- Strategic importance of enemy land forts in the region
NDefines.NAI.LAND_COMBAT_ENEMY_COASTAL_FORTS_AIR_IMPORTANCE = 0 --3	-- Strategic importance of enemy coastal fronts in the region
...
NDefines.NAI.LAND_COMBAT_CAS_WINGS_PER_ENEMY_ARMY_LIMIT = 100 --4	-- Limit of CAS wings requested by enemy armies
NDefines.NAI.LAND_COMBAT_CAS_PER_ENEMY_ARMY = 200 --20				-- Amount of CAS planes requested per enemy army
NDefines.NAI.LAND_COMBAT_CAS_PER_COMBAT = 200 --200					-- Amount of CAS requested per combat	
...
NDefines.NAI.LAND_COMBAT_MIN_EXCORT_WINGS = 10 --2					-- Min amount of airwings requested to excort operations
...
NDefines.NAI.STR_BOMB_MIN_EXCORT_WINGS = 0 --2						-- Min amount of airwings requested to excort operations
